...
help:
	...
	@echo "  1. Klasör Yapısı            : Tüm laboratuvarlar 'denemelerim/' klasörü altında olmalı."
	@echo "  Not: istenirse SRC_DIR değişkeni ile farklı bir ana klasör de belirlenebilir."
	@echo "  2. Ana Programlar          : İçinde 'int main()' olan ve bağımsız çalışacak"
	@echo "                               dosyaların adı '_main.cpp' ile BİTMELİDİR."
	@echo "                               (Örn: custom_allocator_main.cpp)"
	@echo "  3. Yardımcı Dosyalar       : Düz '.cpp' uzantılı dosyalar nesne/yardımcı"
	@echo "                               kabul edilir ve '_main.cpp' olan komutanlara"
	@echo "                               otomatik olarak bağlanır."
	@echo "  4. Çıktılar (Binaries)     : Derlenen tüm çalıştırılabilir dosyalar projenin"
	@echo "                               en dışındaki ortak 'bin/' klasöründe toplanır."
	@echo "  5. Alt Makefile'lar        : Bir alt klasörün içinde özel bir Makefile varsa,"
